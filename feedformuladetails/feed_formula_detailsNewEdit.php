...
$allowed_users = ['vedant', 'divya','venkat']; 
...
$query = "SELECT * FROM feed_formula_detail WHERE feed_formulaType = ? ORDER BY type, quantity Desc;";
$stmt = $mysqli->prepare($query);
$stmt->bind_param("s", $feed_formulaType);
$stmt->execute();
