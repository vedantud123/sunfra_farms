...
<script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/js/all.min.js" defer></script>
  ...
  <script>
	  ...
	  function fetchAndRenderData(date) {
		...
		fetch(`https://sunfra.com/farm/sunfra/egg_godown/egg_godown_stock_json.php?date=${date}&client_id=${clientId}`)
		  .then(res => {
	 ...
	 document.getElementById("eggForm").addEventListener("submit", function (e) {
	  ...
	  fetch("https://sunfra.com/farm/sunfra/egg_godown/egg_godown_stock_save.php", {
		method: "POST",
	  ...
	  function toggleSubmenu(id) {
		...
		document.getElementById("balanceBtn").addEventListener("click", function() {
		  ...
		  function loadBalanceData(date) {
			const url = `https://sunfra.com/farm/sunfra/egg_godown/egg_godown_balance_json.php?client_id=${clientId}&date=${date}`;
		  ...
		  document.addEventListener("DOMContentLoaded", function () {
				fetch("https://sunfra.com/farm/sunfra/egg_godown/cron_for_egg_godown_balance.php")
