...
addLocationForm.addEventListener('submit', e => {
  ...
  fetch('https://sunfra.com/farm/sunfra/configuration/config_location_save.php', {
    method: 'POST',
...
modalSheadBoxForm.addEventListener('submit', async (e) => {
  ...
  try {
    ...
    const res = await fetch('https://sunfra.com/farm/sunfra/configuration/config_shead_box_save.php', {
      method: 'POST',
      body: formData
    });
...
function fetchSheads() {
  ...
  fetch(`https://sunfra.com/farm/sunfra/configuration/shead_number_json.php?client_id=${clientId}`)
    .then(response => response.json())
    .then(data => {
...
function fetchSheadBoxes() {
  ...
  fetch(`https://sunfra.com/farm/sunfra/configuration/config_shead_box_json.php?client_id=${clientId}`)
    .then(response => response.json())
    .then(data => {
...
modalChickForm.addEventListener('submit', async (e) => {
  ...
  try {
    ...
    const res = await fetch('https://sunfra.com/farm/sunfra/configuration/config_chick_shead_save.php', {
      method: 'POST',
      body: formData
    });
    const data = await res.json();
...
function fetchChicks() {
  ...
  fetch(`https://sunfra.com/farm/sunfra/configuration/config_chick_shead_json.php?client_id=${clientId}`)
    .then(response => response.json())
    .then(data => {
...
modalGrowerForm.addEventListener('submit', async (e) => {
  ...
  try {
    ...
    const res = await fetch('https://sunfra.com/farm/sunfra/configuration/config_grower_shead_save.php', {
      method: 'POST',
      body: formData
    });
    const data = await res.json();
...
function fetchGrowers() {
  ...
  fetch(`https://sunfra.com/farm/sunfra/configuration/config_grower_shead_json.php?client_id=${clientId}`)
    .then(response => response.json())
    .then(data => {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function loadSupervisors() {
    fetch(`https://sunfra.com/farm/sunfra/configuration/config_supervisor_json.php?client_id=${clientId}`)
      .then(res => res.json())
      .then(data => {
  ...
  function removeSupervisor(id) {
    ...
    fetch("https://sunfra.com/farm/sunfra/configuration/config_supervisor_delete.php", {
      method: "POST",
      headers: { "Content-Type": "application/x-www-form-urlencoded" },
      body: `id=${id}`
    })
  ...
  openBtn.addEventListener("click", function () {
    ...
    fetch("https://sunfra.com/farm/sunfra/login/farm_users_list.php")
      .then(res => res.json())
      .then(data => {
  ...
  supervisorForm.addEventListener("submit", function (e) {
    ...
    fetch("https://sunfra.com/farm/sunfra/configuration/config_supervisor_save.php", {
      method: "POST",
      body: formData
    })
      .then(res => res.text())
