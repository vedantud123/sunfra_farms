...
<script>
  ...
  function populateSheadDropdown() {
	...
	fetch('https://sunfra.com/farm/sunfra/profit_and_loss_details/egg_cutting_json.php?client_id=${client_id}')
  ...
  form.addEventListener('submit', function (e) {
    ...
    fetch('https://sunfra.com/farm/sunfra/profit_and_loss_details/egg_cutting_save.php', {
      method: 'POST',
      body: formData
    })
      .then(res => res.json())
