...
const api_url = `https://sunfra.com/farm/sunfra/profit_and_loss_details/labour_salary_json.php?client_id=${client_id}`;
const save_url = `https://sunfra.com/farm/sunfra/profit_and_loss_details/labour_salary_save.php`;
const labourMasterUrl = `https://sunfra.com/farm/sunfra/attendance/labour_master_json.php?client_id=${client_id}`;
let existingNames = [];
let allLabourNames = [];
