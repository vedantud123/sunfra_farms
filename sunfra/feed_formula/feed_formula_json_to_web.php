...
async function fetchMainData() {
  const res = await fetch(`https://sunfra.com/farm/sunfra/feed_formula/feed_formula_json.php?client_id=${clientId}`);
...
async function fetchRunningWeeks() {
  const res = await fetch(`https://sunfra.com/farm/sunfra/batch/batch_week_json.php?client_id=${clientId}`);
  const json = await res.json();
  return json[clientId] || [];
}
...
document.getElementById("newMaterialForm").addEventListener("submit", async (e) => {
  ...
  try {
    ...
    const res = await fetch("https://sunfra.com/farm/sunfra/feed_formula/feed_formula_new_material.php", {
      method: "POST",
...
document.getElementById("updateForm").addEventListener("submit", async (e) => {
  ...
  try {
    const res = await fetch("https://sunfra.com/farm/sunfra/feed_formula/feed_formula_update.php", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
async function fetchAvailableRawMaterials() {
  const res = await fetch(`https://sunfra.com/farm/sunfra/feedrawmaterial/feed_raw_material_json.php?client_id=${clientId}`);
  const json = await res.json();
