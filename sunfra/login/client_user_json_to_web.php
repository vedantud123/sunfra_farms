...
<script>
  ...
  document.getElementById("userForm").addEventListener("submit", async function (e) {
    ...
    try {
      const res = await fetch("https://sunfra.com/farm/sunfra/login/client_user_save.php", {
        method: "POST",
  ...
  async function loadUsers() {
    try {
      const res = await fetch("https://sunfra.com/farm/sunfra/login/farm_users_json.php");
