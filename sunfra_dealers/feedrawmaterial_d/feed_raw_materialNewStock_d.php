...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($mysqli->query($query)) {
        header("Location: https://sunfra.com/farm/sunfra_dealers/feedrawmaterial_d/feed_raw_material_d.php");
        exit;
    } else {
...
<body>
    <div class="button-container">
        <button class="Go-Back" onclick="window.location.href='https://sunfra.com/farm/sunfra_dealers/feedrawmaterial_d/feed_raw_material_d.php';">Go Back</button>
    </div>
