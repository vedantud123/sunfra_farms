...
<body>
    <div class="container">
        <button class="go-back-btn" onclick="window.location.href='https://sunfra.com/farm/sunfra_dealers/feedformuladetails_d/feed_formula_details_d.php'">Go Back</button>
        <h1>Select Material to Remove</h1>
        <form action="feed_formula_removeMaterial_remove_d.php" method="post">
            <p>
