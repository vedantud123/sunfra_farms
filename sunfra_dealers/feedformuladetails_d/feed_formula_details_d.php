...
<div class="container">
    <button onclick="window.location.href='https://sunfra.com/farm/sunfra_dealers/index_d.php'">Go Back</button>
    <h1>Feed Formulas</h1>
    ...
    <?php
        ...
        echo '
        <div class="add-data">
            <a href="feed_formula_newMaterial_d.php">Add New Material</a>
        </div>';

	
        echo '
        <div class="add-data">
            <a href="feed_formula_edit_d.php">Edit Formula</a>
        </div>';
    ...
    <?php
        echo '<a href="feed_formula_removeMaterial_d.php">Remove Existing Material</a>';
    ?>
</div>
