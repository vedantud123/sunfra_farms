  ...
  <style>
    ...
    body {
	  ...
	  background: linear-gradient(rgba(9,108,108,0.75), rgba(9,108,108,0.75)),
				  url("http://sunfra.com/farm/sunfra_clients/index/poultry.jpg");
...
async function fetchProfitLoss(fromDate, toDate) {
  const url = `https://sunfra.com/farm/sunfra_clients/profit_and_loss_details/profit_loss_json.php?client_id=${clientId}&from_date=${fromDate}&to_date=${toDate}`;
  try {
...
async function fetchMortality(fromDate, toDate) {
  const url = `https://sunfra.com/farm/sunfra_clients/index/mortality_json.php?client_id=${clientId}&from_date=${fromDate}&to_date=${toDate}`;
...
async function fetchEggProduction(fromDate, toDate) {
  const url = `https://sunfra.com/farm/sunfra_clients/index/egg_stock_json.php?client_id=${clientId}&from_date=${fromDate}&to_date=${toDate}`;
  try {
    const res = await fetch(url);
    const text = await res.text();
...
async function fetchEggDamage(fromDate, toDate) {
  const url = `https://sunfra.com/farm/sunfra_clients/index/egg_damage_json.php?client_id=${clientId}&from_date=${fromDate}&to_date=${toDate}`;
  try {
    const res = await fetch(url);
    const text = await res.text();
...
async function fetchFeedIntake(fromDate, toDate) {
  const url = `https://sunfra.com/farm/sunfra_clients/index/feed_intake_json.php?client_id=${clientId}&from_date=${fromDate}&to_date=${toDate}`;
  try {
    const res = await fetch(url);
    const text = await res.text();
    return JSON.parse(text);
...
async function fetchEggWeight(fromDate, toDate) {
  const url = `https://sunfra.com/farm/sunfra_clients/index/egg_weight_json.php?client_id=${clientId}&from_date=${fromDate}&to_date=${toDate}`;
  try {
    const res = await fetch(url);
    const text = await res.text();
...
async function fetchProductionPercentage(fromDate, toDate) {
  const url = `https://sunfra.com/farm/sunfra_clients/index/production_percentage_json.php?client_id=${clientId}&from_date=${fromDate}&to_date=${toDate}`;
  try {
    const res = await fetch(url);
    const text = await res.text();
...
async function fetchEggSale(fromDate, toDate) {
  const url = `https://sunfra.com/farm/sunfra_clients/index/egg_sale_json.php?client_id=${clientId}&from_date=${fromDate}&to_date=${toDate}`;
  try {
    const res = await fetch(url);
    const text = await res.text();
...
async function fetchTemperature(date = null) {
  ...
  const url = `https://sunfra.com/farm/sunfra_clients/index/temperature_json.php?client_id=${clientId}&date=${date}`;
