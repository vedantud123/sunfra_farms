...
$api_url = "https://sunfra.com/farm/sunfra_clients/egg_godown/egg_godown_party_name.php?client_id=$client_id&date=$date";
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/js/all.min.js" defer></script>
  ...
  const apiUrl = `https://sunfra.com/farm/sunfra_clients/egg_godown/egg_godown_sale_json.php?client_id=${clientId}`;
  const saveApiUrl = "https://sunfra.com/farm/sunfra_clients/egg_godown/egg_godown_sale_save.php";
...
window.addEventListener("click", function (event) {
  ...
  document.getElementById("damageForm").addEventListener("submit", async function (e) {
    ...
    try {
      const response = await fetch("https://sunfra.com/farm/sunfra_clients/egg_godown/egg_godown_sale_damage_save.php", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
