...
async function loadSanitizationData(filters = {}) {
  try {
    const response = await fetch(`https://sunfra.com/farm/sunfra_clients/feedrawmaterial/water_medicine_json.php?client_id=${clientId}`);
...
document.getElementById("entryForm").addEventListener("submit", async function (e) {
  ...
  try {
    const response = await fetch("https://sunfra.com/farm/sunfra_clients/feedrawmaterial/water_medicine_save.php", {
      method: "POST",
      body: formData
    });
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    const shedRes = await fetch(`https://sunfra.com/farm/sunfra_clients/configuration/shead_chick_grower_json.php?client_id=${clientId}`);
  ...
  try {
	  const matRes = await fetch(`https://sunfra.com/farm/sunfra_clients/feedrawmaterial/feed_raw_material_json.php?client_id=${clientId}`);
