...
<main class="content main-content">
  ...
  <script>
	...
	const apiUrl = `https://sunfra.com/farm/sunfra_clients/feedrawmaterial/feed_raw_material_json.php?client_id=${clientId}`;
	...
	document.getElementById("materialForm").addEventListener("submit", async function (e) {
	  ...
	  const response = await fetch("https://sunfra.com/farm/sunfra_clients/feedrawmaterial/feed_raw_material_save.php", {
		method: "POST",
