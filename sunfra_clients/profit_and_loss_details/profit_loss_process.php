...
$location_url = "https://sunfra.com/farm/sunfra_clients/configuration/config_location_json.php?client_id=$client_id";
...
foreach ($final_list as $shead) {
	$shead_name = '';
	$total_cal = $medicine_cal = $tons = $total_amount = $batch_id_result = 0;
