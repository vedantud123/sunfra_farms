...
const apiUrl = `https://sunfra.com/farm/sunfra_clients/profit_and_loss_details/vaccination_json.php?client_id=${client_id}`;
const postUrl = `https://sunfra.com/farm/sunfra_clients/profit_and_loss_details/vaccination_save.php`;
const sheadApiUrl = `https://sunfra.com/farm/sunfra_clients/configuration/shead_chick_grower_json.php?client_id=${client_id}`;
