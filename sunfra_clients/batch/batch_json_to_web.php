...
$json_url = "https://sunfra.com/farm/sunfra_clients/batch/batch_json.php?client_id=" . urlencode($client_id);
   ...
   document.addEventListener('DOMContentLoaded', function() {
    ...
    if (batchForm) {
       batchForm.addEventListener('submit', function(e) {
		...
		const apiUrl = 'https://sunfra.com/farm/sunfra_clients/batch/batch_save.php';  
