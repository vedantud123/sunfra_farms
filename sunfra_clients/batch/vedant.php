<div class="sidebar" id="sidebar">
  ...
  <a href="https://sunfra.com/farm/sunfra_clients/batch_json_to_web.php"><i class="fas fa-globe"></i><span class="label">Batch</span></a>
  <a href="https://sunfra.com/farm/sunfra_clients/weighbridge_json_to_web.php"><i class="fas fa-truck"></i><span class="label">WeighBridge</span></a>
  <a href="https://sunfra.com/farm/sunfra_clients/tractor_production_mortality_json_to_web.php"><i class="fas fa-tractor"></i><span class="label">Tractor Production</span></a>
  ...
  <div class="attendance-dropdown">
    ...
    <div class="attendance-submenu" id="attendanceSubmenu">
      <button onclick="location.href='https://sunfra.com/farm/sunfra_clients/labour_master_json_to_web.php'">👷‍♂️ Labour Details</button>
      <button onclick="location.href='https://sunfra.com/farm/sunfra_clients/labour_attendance_json_to_web.php'">📅 Labour Attendance</button>
  ...
  <div class="attendance-dropdown">
    ...
    <div class="attendance-submenu" id="feedPlantSubmenu">
      <button onclick="location.href='https://sunfra.com/farm/sunfra_clients/feedformuladetails/feed_formula_details.php'">⚙️ Feed Formula</button>
      ...
      <button onclick="location.href='https://sunfra.com/farm/sunfra_clients/feedsheadfeeding/feed_shead_feeding.php'">🚚 Feed Material To Shead</button>
      <button onclick="location.href='https://sunfra.com/farm/sunfra_clients/sanitization/sanitization.php'">🧪 Water Medicine</button>
      <button onclick="location.href='https://sunfra.com/farm/sunfra_clients/feednewstockloading/feed_new_stock_loading.php'">📦 Update Raw Material</button>
    </div>
  </div>
  ...
  <div class="attendance-dropdown">
    ...
    <div class="attendance-submenu" id="eggGodownSubmenu">
      <button onclick="location.href='https://sunfra.com/farm/sunfra_clients/egg_godown/egg_godown_stock.php'">🥚 Egg Production From Shead</button>
      <button onclick="location.href='https://sunfra.com/farm/sunfra_clients/egg_godown/egg_godown_sale.php'">💰 Eggs for Sale</button>
      <button onclick="location.href='https://sunfra.com/farm/sunfra_clients/egg_godown/egg_weight.php'">⚖️ Egg Weight</button>
    </div>
  </div>
  ...
  <div class="attendance-dropdown">
    ...
    <div class="attendance-submenu" id="profitLossSubmenu">
      <button onclick="location.href='https://sunfra.com/farm/sunfra_clients/profit_and_loss_details/feed_material_price_perkg.php'">Feed Material Price</button>
      <button onclick="location.href='https://sunfra.com/farm/sunfra_clients/profit_and_loss_details/egg_cutting_price.php'">Egg Price Per Piece</button>
      <button onclick="location.href='https://sunfra.com/farm/sunfra_clients/profit_and_loss_details/water_medicine_and_sanitization_price.php'">Water & Sanitization</button>
      ...
      <button onclick="location.href='https://sunfra.com/farm/sunfra_clients/profit_and_loss_details/vaccination_costing.php'">Vaccination</button>
      <button onclick="location.href='https://sunfra.com/farm/sunfra_clients/profit_and_loss_details/labour_salary_details.php'">Labour Salary</button>
    </div>
  </div>
  ...
  <a href="https://sunfra.com/farm/sunfra_clients/login2/client_user_json_to_web.php"><i class="fas fa-user-plus"></i><span class="label">Registration</span></a>
  ...
  <a href="https://sunfra.com/farm/sunfra_clients/login2/logout.php"><i class="fas fa-sign-out-alt"></i><span class="label">Logout</span></a>
</div>
...
<div class="sidebar" id="sidebar">
  ...
  <div class="attendance-dropdown">
    ...
    <div class="attendance-submenu" id="attendanceSubmenu">
      ...
      <button onclick="location.href='https://sunfra.com/farm/sunfra_clients/attendance/new_labour_master.php'">📝 Assigned Master</button>
    </div>
  </div>
	<div class="attendance-dropdown">
  ...
  <div class="attendance-dropdown">
    ...
    <div class="attendance-submenu" id="profitLossSubmenu">
      ...
      <button onclick="location.href='https://sunfra.com/farm/sunfra_clients/profit_and_loss_details/profit_and_loss_daily.php'">Profit & Loss Summary</button>
      <button onclick="location.href='https://sunfra.com/farm/sunfra_clients/dashboard.php'">Summary Report</button>
