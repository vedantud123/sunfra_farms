...
$json = file_get_contents("https://sunfra.com/farm/sunfra_clients/weighbridge/weighbridge_json.php?client_id=$client_id");
...
$raw_json = file_get_contents("https://sunfra.com/farm/sunfra_clients/feedrawmaterial/feed_raw_material_json_for_weighbridge.php?client_id=$client_id");
...
<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <form action="https://sunfra.com/farm/sunfra_clients/weighbridge/weighbridge_save.php" method="POST" id="with-weighbridge-form" class="d-none p-3">
        ...
        <div class="modal-body row g-3">
          ...
          <div class="col-md-3"><label>Vehicle Number</label><input name="vehicleNumber" class="form-control" ></div>
          <div class="col-md-4">
      ...
      <form action="https://sunfra.com/farm/sunfra_clients/weighbridge/weighbridge_save.php" method="POST" id="without-weighbridge-form" class="d-none p-3">
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <form action="https://sunfra.com/farm/sunfra_clients/weighbridge/weighbridge_save.php" method="POST">
      ...
      <div class="modal-body">
        <form id="materialPriceForm">
		  ...
		  <div class="mb-3">
			  ...
			  <input type="number" class="form-control" id="materialPrice" step="any" required>
			</div>
...
<script>
 $(document).ready(function() {
  ...
  $('#materialPriceForm').on('submit', function(e) {
    ...
    fetch('https://sunfra.com/farm/sunfra_clients/weighbridge/update_material_price.php', {
      method: 'POST',
