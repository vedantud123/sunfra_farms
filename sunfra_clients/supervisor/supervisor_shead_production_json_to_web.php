...
<script>
	...
	document.addEventListener("DOMContentLoaded", function () {
	  ...
	  document.getElementById("entryForm").addEventListener("submit", function (e) {
		...
		fetch("https://sunfra.com/farm/sunfra_clients/supervisor/supervisor_shead_production_save.php", {
		  method: "POST",
		  body: formData,
		})
		  .then(response => response.json())
	...
	document.addEventListener("DOMContentLoaded", function () {
	  ...
	  const sheadUrl = `https://sunfra.com/farm/sunfra_clients/configuration/shead_chick_grower_json.php?client_id=${clientId}`;
