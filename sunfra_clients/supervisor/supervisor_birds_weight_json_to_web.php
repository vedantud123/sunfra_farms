...
<script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/js/all.min.js" defer></script>
  ...
  <script>
    ...
    const apiUrl = "https://sunfra.com/farm/sunfra_clients/supervisor/supervisor_birds_weight_json.php";
    const saveApi = "https://sunfra.com/farm/sunfra_clients/supervisor/supervisor_birds_weight_save.php";
   ...
   function fetchData() {
	  fetch('https://sunfra.com/farm/sunfra_clients/supervisor/supervisor_birds_weight_json.php?client_id=' + clientId)
