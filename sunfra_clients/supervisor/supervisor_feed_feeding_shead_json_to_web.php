...
$box_api_url = "https://sunfra.com/farm/sunfra_clients/configuration/config_shead_box_json.php?client_id=" . $client_id;
   ...
   <script>
	...
	$(document).ready(function () {
		...
		$('#entryForm').submit(function (e) {
			...
			$.ajax({
				url: 'https://sunfra.com/farm/sunfra_clients/supervisor/supervisor_feed_feeding_shead_save.php',
				method: 'POST',
				data: payload,
				dataType: 'json',
	...
	function loadData(filterDate = '') {
		const configUrl = "https://sunfra.com/farm/sunfra_clients/configuration/config_shead_box_json.php?client_id=" + clientId;
		const dataUrl = "https://sunfra.com/farm/sunfra_clients/supervisor/supervisor_feed_feeding_shead_json.php?client_id=" + clientId;
