...
<main class="content main-content">
  ...
  const clientId = "<?php echo $client_id; ?>"; 
	...
	const apiURL = `https://sunfra.com/farm/sunfra_clients/supervisor/supervisor_shead_mortality_json.php?client_id=${clientId}`;
  ...
  addForm.addEventListener("submit", async (e) => {
    ...
    const response = await fetch("https://sunfra.com/farm/sunfra_clients/supervisor/supervisor_shead_mortality_save.php", {
      method: "POST",
