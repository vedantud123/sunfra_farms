   ...
   <h1>🌱 Labour Attendance</h1>
	...
	<div id="formModal" class="modal">
		<div class="modal-content">
			...
			<form id="attendanceForm" method="POST" action="https://sunfra.com/farm/sunfra_clients/attendance/labour_attendance_save.php">
	...
	Promise.all([
			fetch(`https://sunfra.com/farm/sunfra_clients/attendance/labour_attendance_json.php?client_id=${clientId}`).then(res => res.json()),
			fetch(`https://sunfra.com/farm/sunfra_clients/attendance/labour_master_json.php?client_id=${clientId}`).then(res => res.json())
		])
	...
	function openEditForm(id, name, status, working_place) {
		...
		document.getElementById('attendanceForm').action = 'https://sunfra.com/farm/sunfra_clients/attendance/labour_attendance_save.php';
	}

		const today = new Date().toISOString().split('T')[0]; 

		Promise.all([
		  fetch(`https://sunfra.com/farm/sunfra_clients/attendance/labour_master_json.php?client_id=${clientId}`).then(r => r.json()),
		  fetch(`https://sunfra.com/farm/sunfra_clients/attendance/labour_attendance_json.php?client_id=${clientId}`).then(r => r.json())
		])
