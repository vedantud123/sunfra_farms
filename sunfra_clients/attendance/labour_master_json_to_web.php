  ...
  <script>
    ...
    document.getElementById("searchInput").addEventListener("input", function () {
      ...
      renderPagination();
	   ...
	   function fetchData() {
		fetch(`https://sunfra.com/farm/sunfra_clients/attendance/labour_master_json.php?client_id=${clientId}`)
	...
	function openModal(editData = null) {
		...
		window.onclick = function(event) {
		 ...
		 document.getElementById("labourForm").addEventListener("submit", function(e) {
			...
			fetch("https://sunfra.com/farm/sunfra_clients/attendance/labour_master_save.php", {
			  method: "POST",
			  body: formData,
			})
			.then(response => {
