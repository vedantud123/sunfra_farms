...
async function loadAssignments() {
    const locRes = await fetchJSON(`https://sunfra.com/farm/sunfra_clients/configuration/config_location_json.php?client_id=${client_id}`);
    locations = locRes[client_id] || [];

    const userRes = await fetchJSON(`https://sunfra.com/farm/sunfra_clients/login/farm_users_json.php`);
