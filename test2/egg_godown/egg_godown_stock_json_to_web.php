...
<script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/js/all.min.js" defer></script>
  ...
  <script>
	  ...
	  function fetchAndRenderData(date) {
		...
		fetch(`https://sunfra.com/farm/test2/egg_godown/egg_godown_stock_json.php?date=${date}&client_id=${clientId}`)
		  .then(res => {
	 ...
	 document.getElementById("eggForm").addEventListener("submit", function (e) {
	  ...
	  fetch("https://sunfra.com/farm/test2/egg_godown/egg_godown_stock_save.php", {
		method: "POST",
