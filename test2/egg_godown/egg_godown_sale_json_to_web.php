...
$shead_url = "https://sunfra.com/farm/test2/configuration/shead_number_json.php?client_id=$client_id";
...
$api_url = "https://sunfra.com/farm/test2/egg_godown/egg_godown_party_name.php?client_id=$client_id&date=$date";
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/js/all.min.js" defer></script>
  ...
  const apiUrl = `https://sunfra.com/farm/test2/egg_godown/egg_godown_sale_json.php?client_id=${clientId}`;
  const saveApiUrl = "https://sunfra.com/farm/test2/egg_godown/egg_godown_sale_save.php";
    ...
    try {
      ...
      document.getElementById('searchInput').addEventListener('input', function () {
        ...
        const filtered = allRecords.filter(item =>
          ...
          item.shead_name.toLowerCase().includes(query) ||
          item.type_of_eggs.toLowerCase().includes(query) ||
          item.sale.toLowerCase().includes(query)
        );
...
window.addEventListener("click", function(event) {
  ...
  document.getElementById("damageForm").addEventListener("submit", async function (e) {
    ...
    try {
      const response = await fetch("https://sunfra.com/farm/test2/egg_godown/egg_godown_sale_damage_save.php", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
