...
<script>
	...
	function fetchData() {
	  const url = `https://sunfra.com/farm/test2/tractor_production_mortality/tractor_production_mortality_json.php?client_id=${clientId}`;
	...
	function displayData(dataArray) {
	  ...
	  document.getElementById('dataForm').addEventListener('submit', function(event) {
		...
		fetch('https://sunfra.com/farm/test2/tractor_production_mortality/tractor_production_mortality_save.php', {
		  method: 'POST',
