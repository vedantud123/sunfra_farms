...
<script>
  ...
  const API_URL = `https://sunfra.com/farm/test2/feedrawmaterial/feed_to_shead_json.php?client_id=${clientId}`;
 ...
 async function loadData() {
  ...
  document.getElementById("feedForm").addEventListener("submit", async function(e) {
    ...
    try {
      const res = await fetch("https://sunfra.com/farm/test2/feedrawmaterial/feed_to_shead_save.php", {
        method: "POST",
        body: formData
      });
