...
async function loadSanitizationData(filters = {}) {
  try {
    const response = await fetch(`https://sunfra.com/farm/test2/feedrawmaterial/water_medicine_json.php?client_id=${clientId}`);
...
document.getElementById("entryForm").addEventListener("submit", async function (e) {
  ...
  try {
    const response = await fetch("https://sunfra.com/farm/test2/feedrawmaterial/water_medicine_save.php", {
      method: "POST",
      body: formData
    });
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    const shedRes = await fetch(`https://sunfra.com/farm/test2/configuration/shead_number_json.php?client_id=${clientId}`);
  ...
  try {
	  const matRes = await fetch(`https://sunfra.com/farm/test2/feedrawmaterial/feed_raw_material_json.php?client_id=${clientId}`);
