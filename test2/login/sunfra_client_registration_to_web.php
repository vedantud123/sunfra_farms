...
<script>
  document.getElementById("clientForm").addEventListener("submit", async function (e) {
    ...
    try {
      const res = await fetch("https://sunfra.com/farm/test2/login/sunfra_client_registration_save.php", {
        method: "POST",
	...
	function loadClients() {
	  ...
	  fetch("https://sunfra.com/farm/test2/login/sunfra_client_json.php")
		.then(res => res.json())
		.then(data => {
