...
function loadMaterials() {
  fetch(`https://sunfra.com/farm/test2/profit_and_loss_details/material_cost_json.php?client_id=${clientId}`)
    .then(res => res.json())
    .then(data => {
...
function loadMaterialOptions() {
  fetch(`https://sunfra.com/farm/test2/feedrawmaterial/feed_raw_material_json.php?client_id=${clientId}`)
    .then(res => res.json())
    .then(data => {
...
function saveEdit() {
  ...
  fetch('https://sunfra.com/farm/test2/profit_and_loss_details/material_cost_save.php', {
    method: 'POST',
