...
if ($id > 0) {
    ...
    $sql = "INSERT INTO labour_master 
            ...
            VALUES 
                ('$name', '$dateOfBirth', '$address', '$phoneNumber', '$aadhar', '$joiningReference', '$relatedTo', '$startDate', " . ($endDate ? "'$endDate'" : "NULL") . ", $client_id)";
}

if (mysqli_query($conn, $sql)) {
    header("Location: https://sunfra.com/farm/test/labour_master_json_to_web.php");
    exit;
} else {
