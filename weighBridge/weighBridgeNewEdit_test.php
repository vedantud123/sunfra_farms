        ...
        <form action="" method="post">
            ...
            <div class="form-group">
				...
				<select name="material" id="material">
					...
					<option value="Shead 1" <?= (isset($shead_name) && $shead_name == 'Shead 1') ? 'selected' : ''; ?> value="<?= $material ?>>Shead 1</option>
					<option value="Shead 2" <?= (isset($shead_name) && $shead_name == 'Shead 2') ? 'selected' : ''; ?> value="<?= $material ?>>Shead 2</option>
					<option value="Shead 3" <?= (isset($shead_name) && $shead_name == 'Shead 3') ? 'selected' : ''; ?> value="<?= $material ?>>Shead 3</option>
					<option value="Shead 4" <?= (isset($shead_name) && $shead_name == 'Shead 4') ? 'selected' : ''; ?> value="<?= $material ?>>Shead 4</option>
					<option value="Shead 5" <?= (isset($shead_name) && $shead_name == 'Shead 5') ? 'selected' : ''; ?> value="<?= $material ?>>Shead 5</option>
					<option value="Shead 6" <?= (isset($shead_name) && $shead_name == 'Shead 6') ? 'selected' : ''; ?> value="<?= $material ?> >Shead 6</option>
					<option value="Shead 7" <?= (isset($shead_name) && $shead_name == 'Shead 7') ? 'selected' : ''; ?> value="<?= $material ?>>Shead 7</option>
					<option value="Shead 8" <?= (isset($shead_name) && $shead_name == 'Shead 8') ? 'selected' : ''; ?> value="<?= $material ?>>Shead 8</option>
				</select>
            </div>
            <div class="form-group">
